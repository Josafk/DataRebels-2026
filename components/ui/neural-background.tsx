...
// ===================== SHADER CPPN (ShaderBackground + ShaderPlane) =====================
const vertexShader = `
  varying vec2 vUv;
  void main() {
    vUv = uv;
...
const fragmentShader = `
  ...
  void main() {
    ...
    vec4 col = cppn_fn(uv, 0.15 * sin(0.5 * iTime), 0.15 * sin(0.8 * iTime), 0.15 * sin(0.6 * iTime));
    gl_FragColor = vec4(col.rgb * 1.3, 0.15);
  }
`;
...
function ShaderPlane() {
  ...
  return (
    <mesh ref={meshRef} position={[0, 0, 0]}>
      ...
      <cPPNShaderMaterial ref={materialRef} side={THREE.DoubleSide} transparent={true} />
    </mesh>
  );
}
...
export function NeuralBackground() {
  ...
  return (
    <div
      ...
      style={{ width: '100vw', height: '100vh', minWidth: '100vw', minHeight: '100vh', background: '#000' }}
      aria-hidden
    >
      <div
